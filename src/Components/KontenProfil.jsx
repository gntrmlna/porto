...
export default function KontenProfil() {
  return (
    <div className='bg-secondColor mt-8 pt-16 pl-8 pr-8 pb-12 lg:pt-52 lg:pl-52 lg:pr-52 lg:pb-40 text-white rounded-md lg:rounded-none'>
        <h1 className='text-2xl lg:text-4xl mb-8'>Halo, Saya Guntur. Selamat Datang Ya !</h1>
